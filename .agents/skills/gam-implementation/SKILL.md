...
- Handoffs produced by `$handoff` may summarize implementation context for another chat, but they must reference requirements, tests, changed files, and verification output instead of replacing them.
