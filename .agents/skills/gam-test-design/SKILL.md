...
- Handoffs produced by `$handoff` may summarize test context for another chat, but they must reference Requirement Specifications and test files instead of replacing them.
